...
/**************************************************************************
* Network Training Episodes Initialization
**************************************************************************/

// Coordination with NetData chare array
//
void Network::InitEpsPlastic(CProxy_Netdata cpdat) {
  // Set proxies
  netdata = cpdat;
  cbcycleprt = CkCallback(CkIndex_Network::CycleEpsPlastic(), prtidx, thisProxy);
...
//
void Network::SaveEpisode() {
  // Start a new cycle (checked data sent)
  thisProxy.CycleEpsPlastic();
}
